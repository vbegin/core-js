...
for (PATH of ['core-js-pure', 'core-js']) {
  ...
  let Map = load('full/map');
  let Set = load('full/set');
  let WeakMap = load('full/weak-map');
  let WeakSet = load('full/weak-set');
  ...
  let Promise = load('full/promise/constructor');
  ...
  const instanceAt = load('full/instance/at');
